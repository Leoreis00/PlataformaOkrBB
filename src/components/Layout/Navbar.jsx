  ...
  return (
    <div className={`sidebar ${isExpanded ? "expanded" : "collapsed"}`}>
      ...
      <div className="menu">
        ...
        <div className="with-submenu">
          ...
          {activeMenu === "okrs" && isExpanded && (
            <div className="submenu">
              ...
              <div className={`submenu-item ${isActive("/cadastrar-okr") ? "active" : ""}`}>
                <Link to="/cadastrar-okr" className="submenu-link">Cadastrar OKR</Link>
              </div>
            </div>
          )}
        </div>
        ...
        {/* Configurações */}
        <div className={`menu-item ${isActive("/configuracoes") ? "active" : ""}`}>
          <Link to="/configuracoes" className="menu-link">
            <img className="StyleIcones" src={iconeConfig} alt="Configurações"/>
